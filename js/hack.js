...
// This entry need to be wrapped in an IIFE because it need to be isolated against other modules in the chunk.
  ...
  \******************************/
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      document.querySelector('.navbar__close').addEventListener('click', function (e) {
      ...
      //SLIDER
      var sliders = document.getElementsByClassName('section_methods__cloud__line');
      var speed = [1, 1.2, 0.8];

      for (var i = 0; i < sliders.length; i++) {
        new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide(sliders[i], {
          type: 'loop',
          drag: 'free',
          mode: 'free',
          snap: false,
      ...
      document.querySelectorAll('.faq').forEach(function (item) {
        item.addEventListener('click', function (e) {
          ...
          if (!parent.classList.contains('_open')) parent.classList.add('_open');else parent.classList.remove('_open');
        });
      }); //RADIO

      document.querySelectorAll('.section_methods__select label.radio').forEach(function (item) {
        item.addEventListener('click', function (e) {
          if (document.querySelector('.section_methods__select .radio._active')) document.querySelector('.section_methods__select .radio._active').classList.remove('_active');
          this.classList.add('_active');
          document.querySelectorAll('[data-group-item=' + item.dataset.group + ']').forEach(function (t) {
            t.style.display = 'none';
          });
          document.querySelector(item.dataset.val).style.display = 'flex';
        });
      }); //MAP
      ...
      if(a) {
        ...
        document.getElementsByClassName('section_header__map')[0].appendChild(circleCloneFirst);
        document.getElementsByClassName('section_header__map')[0].appendChild(circleCloneSecond);
        document.getElementsByClassName('section_header__map')[0].appendChild(circleCloneThird);
